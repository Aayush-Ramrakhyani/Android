...
public class Main35Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reff2 = FirebaseDatabase.getInstance().getReference().child("data4");
        member = new Member4();
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            case R.id.logoutmenu: {
                Intent intent = new Intent(Main35Activity.this, MainActivity.class);
                startActivity(intent);
                finish();
                Toast.makeText(Main35Activity.this, "Succesfully Logout", Toast.LENGTH_SHORT).show();
                return true;
            }
            case R.id.homemenu: {
                Intent intent = new Intent(Main35Activity.this, Main7Activity.class);
                startActivity(intent);
                finish();
                return true;
            }
    ...
    public void show(View view) {
        ...
        Intent intent;
        intent=new Intent(Main35Activity.this,Main34Activity.class);
