    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot ds : dataSnapshot.getChildren()) {
                    ...
                    if(te.equals(team) && te1.equals(team1)) {
                        t1.setText(team);
                        t2.setText(team1);
                        key = ds.getKey();
                        return;
        ...
        reference2.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                Toast.makeText(Main14Activity.this,g, Toast.LENGTH_LONG).show();
                ...
                for (DataSnapshot ds : dataSnapshot.getChildren()) {
                    ...
                    if (text.contains("Cricket") && gender.equals(g)) {
                        if (clg1.contains(te)) {
        ...
        t1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)   {
                ...
                Intent intent;
                intent =new Intent(Main14Activity.this,Main15Activity.class);
                intent.putExtra("a",a);
                intent.putExtra("d",d);
        ...
        start.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent;
                intent = new Intent(Main14Activity.this, Main16Activity.class);
        ...
        cancel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent;
                intent = new Intent(Main14Activity.this, Main13Activity.class);
                startActivity(intent);
            }
        });
    }
