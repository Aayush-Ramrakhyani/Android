                ...
                reference.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        if(c1==1)
                        {
                            ...
                            Intent myintent = new Intent(view.getContext(),Main39Activity.class);
                        ...
                        {
                            AlertDialog.Builder a=new AlertDialog.Builder(Main38Activity.this);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            case R.id.logoutmenu: {
                Intent intent = new Intent(Main38Activity.this, MainActivity.class);
                startActivity(intent);
                finish();
                Toast.makeText(Main38Activity.this, "Succesfully Logout", Toast.LENGTH_SHORT).show();
                return true;
            }
            case R.id.homemenu: {
                Intent intent = new Intent(Main38Activity.this, Main7Activity.class);
                startActivity(intent);
                finish();
                return true;
            }
