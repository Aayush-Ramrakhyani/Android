...
public class Main23Activity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            case R.id.logoutmenu: {
                ...
                finish();
                Toast.makeText(Main23Activity.this, "Succesfully Logout", Toast.LENGTH_SHORT).show();
                return true;
            }
            case R.id.homemenu: {
                Intent intent = new Intent(Main23Activity.this, Main7Activity.class);
                startActivity(intent);
                finish();
                return true;
            }
    ...
    public void show(View view) {
        ...
        member.setLoss("");
        member.setScore("");
        member.setMatch("Football");
        reff2.push().setValue(member);
        Intent intent;
        intent=new Intent(Main23Activity.this,Main22Activity.class);
