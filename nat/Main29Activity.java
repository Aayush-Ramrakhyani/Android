...
public class Main29Activity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        reference2.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot ds : dataSnapshot.getChildren()) {
                    ...
                    if (text.contains("Basketball") && gender.equals(g)) {
                        if (clg1.contains(te)) {
        ...
        t1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)   {
                ...
                Intent intent;
                intent =new Intent(Main29Activity.this,Main30Activity.class);
                intent.putExtra("a",a);
                intent.putExtra("d",d);
        ...
        start.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent;
                intent = new Intent(Main29Activity.this, Main31Activity.class);
        ...
        cancel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent;
                intent = new Intent(Main29Activity.this, Main28Activity.class);
                startActivity(intent);
            }
        });
    }
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            case R.id.logoutmenu: {
                Intent intent = new Intent(Main29Activity.this, MainActivity.class);
                startActivity(intent);
                finish();
                Toast.makeText(Main29Activity.this, "Succesfully Logout", Toast.LENGTH_SHORT).show();
                return true;
            }
            case R.id.homemenu: {
                Intent intent = new Intent(Main29Activity.this, Main7Activity.class);
                startActivity(intent);
                finish();
                return true;
            }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode==1)
        {
            ...
            {
                String i=data.getStringExtra("items");
                Frefernce = FirebaseDatabase.getInstance();
                ...
                reference.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        int m=0;
                        for (DataSnapshot ds : dataSnapshot.getChildren()) {
                            String key1 = (String) ds.child("key").getValue();
                            if(key.equals(key1))
                            {
                                j[m]=ds.getKey();
                                m++;
