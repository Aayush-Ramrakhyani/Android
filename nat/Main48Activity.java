...
public class Main48Activity extends AppCompatActivity {
    ...
    int srun = 0, nsrun = 0, tscore2,tscore = 0, tball = 0, sball = 0, nsball = 0, twicket = 0, tover = 0, bover = 0, bball = 0, bwicket = 0, brun = 0;
    ...
    Member5 member;
    String s = "s";
    String batsman1,batsman2,bowler,team1,team2,id,id2,tscore1,id3,id4;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        id3 = i.getStringExtra("id3");
        id4 = i.getStringExtra("id4");
        tscore1 = i.getStringExtra("tscore");
        tscore2 =Integer.parseInt(tscore1);
        ...
        zero.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (bball == 5) {
                    ...
                    Intent intent;
                    intent = new Intent(Main48Activity.this, Main20Activity.class);
                ...
                if(tscore > tscore2){
                    f1.getReference().child("data5").child(id).child("won").setValue(team1);
                    f1.getReference().child("data5").child(id).child("loss").setValue(team2);
                    f1.getReference().child("data5").child(id2).child("won").setValue(team1);
                    f1.getReference().child("data5").child(id2).child("loss").setValue(team2);
                    Intent intent;
                    intent = new Intent(Main48Activity.this,Main12Activity.class);
                    startActivity(intent);
                }
                else if(tover == 12){
                    f1.getReference().child("data5").child(id).child("won").setValue(team2);
                    f1.getReference().child("data5").child(id).child("loss").setValue(team1);
                    f1.getReference().child("data5").child(id2).child("won").setValue(team2);
                    f1.getReference().child("data5").child(id2).child("loss").setValue(team1);
                    Intent intent;
                    intent = new Intent(Main48Activity.this,Main12Activity.class);
                    startActivity(intent);
                }
