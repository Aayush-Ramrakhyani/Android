    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        t1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)   {
                ...
                Intent intent;
                intent =new Intent(Main22Activity.this,Main23Activity.class);
                intent.putExtra("a",a);
                intent.putExtra("d",d);
        ...
        start.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent;
                intent = new Intent(Main22Activity.this, Main24Activity.class);
        ...
        cancel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent;
                intent = new Intent(Main22Activity.this, Main21Activity.class);
                startActivity(intent);
            }
        });
    }
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            case R.id.logoutmenu: {
                ...
                startActivity(intent);
                finish();
                Toast.makeText(Main22Activity.this, "Succesfully Logout", Toast.LENGTH_SHORT).show();
                return true;
            }
            case R.id.homemenu: {
                Intent intent = new Intent(Main22Activity.this, Main7Activity.class);
                startActivity(intent);
                finish();
                return true;
            }
