    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for(int j=0;j<i;j++)
                {
                    ref2=Frefernce.getReference().child("data4").child(n[j]).child("players");
        ...
        reference1 = Frefernce.getReference().child("data4");
        reference1.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot ds : dataSnapshot.getChildren()) {
                    ...
                    ref3=Frefernce.getReference().child("data4");
        ...
        d.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent;
                intent =new Intent(Main42Activity.this,Main40Activity.class);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            case R.id.logoutmenu: {
                Intent intent = new Intent(Main42Activity.this, MainActivity.class);
                startActivity(intent);
                finish();
                Toast.makeText(Main42Activity.this, "Succesfully Logout", Toast.LENGTH_SHORT).show();
                return true;
            }
            case R.id.homemenu: {
                Intent intent = new Intent(Main42Activity.this, Main3Activity.class);
                startActivity(intent);
                finish();
                return true;
            }
